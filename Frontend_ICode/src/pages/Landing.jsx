      ...
      <div className="min-h-screen bg-gray-800">
        ...
        <main className="max-w-4xl mx-auto p-8 mt-32">
          <div className="space-y-6 max-w-2xl">
            <h1 className="text-5xl font-bold">Code Anywhere. Run Anywhere.</h1>
            <p className="text-lg">
        ...
        <Section>
          <h2 className="text-3xl font-bold">Why ICode?</h2>
          ...
          <div className="grid grid-cols-3 gap-6 mt-8 p-4 ">
