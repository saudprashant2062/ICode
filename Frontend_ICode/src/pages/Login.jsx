        ...
        <div className="w-full max-w-sm border border-green-500/25 bg-black p-12 shadow-[0_0_20px_rgba(61,220,132,0.03)]">
          ...
          <form className="flex flex-col gap-4">
            ...
            <input
              ...
              className="w-full bg-gray-800 border border-green-500/25 px-4 py-3.5 text-gray-700 placeholder-gray-600 focus:outline-none focus:border-green-400 focus:ring-1 focus:ring-green-400"
            />
